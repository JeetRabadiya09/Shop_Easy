...
import 'package:shop_easy/view/Cartpage/review.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        ...
                        " Super clean code, intuitive documentations, and "
                        "most important of all the best design.",
                        style: TextStyle(
                            color: AppColors.black,
                            fontWeight: FontWeight.w400,
                            fontFamily: "Poppins",
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        "Actually, I can't limit myself to just one "
                        "option and that's why I've put 'Other': "
                        "great theme, thousands of possibilities, great"
                        " technical support (fast, efficient and polite), etc.",
                        style: TextStyle(
                            color: AppColors.black,
                            fontWeight: FontWeight.w400,
                            fontFamily: "Poppins",
